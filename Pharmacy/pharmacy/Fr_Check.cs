...
namespace pharmacy
{
    public partial class Fr_Check : Form
    {
        public Fr_Check()
        {
            InitializeComponent();
        ...
        private void btn_Delete_Click(object sender, EventArgs e)
        {
            ...
            if (res == DialogResult.No)
                return;
            var sql_delete = "DELETE FROM Tbl_Check_D WHERE id=@0";
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            if (Check_Input())
                return;
            var sql_insert = "INSERT INTO Tbl_Check_D (id, SH, Name_H, Name_P, Price, Date1, Date2, Status, Description)" +
        ...
        private void btn_Edit_Click(object sender, EventArgs e)
        {
            if (Check_Input())
                return;
            var sql_update = "UPDATE Tbl_Check_D SET id=@0, SH=@1, Name_H=@2, Name_P=@3, Price=@4, Date1=@5, Date2=@6, Status=@7, Description=@8" +
                " WHERE id=@9";
        ...
        void Load_Data()
        {
            ...
            Db.Adap.SelectCommand.CommandText = "SELECT * FROM Tbl_Check_D";
